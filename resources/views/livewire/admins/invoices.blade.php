                            ...
                            <div class="form-row align-items-end">
                                <div class="form-group col-md-4 mb-0">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" wire:model.defer="search" wire:keydown.enter="$refresh" name="invoice_number_filter" autocomplete="nope" class="form-control border-left-0" placeholder="Search Invoice #...">
                                    </div>
                                </div>
