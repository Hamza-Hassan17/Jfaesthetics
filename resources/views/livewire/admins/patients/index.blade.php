                    ...
                    <div class="form-row align-items-end mb-3">
                        <div class="form-group col-md-4 mb-0">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" wire:model.defer="search" wire:keydown.enter="$refresh" name="patient_name_filter" autocomplete="one-time-code" class="form-control" placeholder="Search patient name...">
                            </div>
                        </div>
